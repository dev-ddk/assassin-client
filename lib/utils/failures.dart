...
abstract class Failure implements Exception {
  ...
  Failure.log(this.code, this.message, Logger logger,
...
class DioNetworkFailure extends Failure {
  ...
  DioNetworkFailure(
      {required String code, required String message, required this.errorType})
      : super(code, message);
...
class AuthFailure extends Failure {
  AuthFailure({required String code, required String message})
      : super(code, message);
...
class RequestFailure extends Failure {
  ...
  RequestFailure(
      {required String code, required String message, required this.response})
      : super(code, message);
...
class LobbyNotExistsFailure extends Failure {
  LobbyNotExistsFailure({required String code, required String message})
      : super(code, message);
...
class CacheFailure extends Failure {
  CacheFailure({required String code, required String message})
      : super(code, message);
...
class PadrinconiaFailure extends Failure {
  PadrinconiaFailure({required String code, required String message})
      : super(code, message);
